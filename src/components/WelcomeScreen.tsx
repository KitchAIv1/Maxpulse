...
import backgroundImage from 'figma:asset/ce5ce6019a6fda95c3a63c46fe96e1ea1cb7f568.png';
...
export function WelcomeScreen({ onStart, isMobile }: WelcomeScreenProps) {
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Background Image - ONLY show on desktop, NOT on mobile */}
      {!isMobile && (
        <div 
