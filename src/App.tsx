...
import { AppState, Priority, UserProfile } from './types/assessment';
...
export default function App() {
  ...
  const getResults = () => calculateResults(currentQuestions, answers, startTime, userProfile, selectedPriority);
            ...
            {appState === 'welcome' && (
              ...
              >
                ...
                <div className="relative z-10">
                  <WelcomeScreen onStart={startPrioritySelection} isMobile={isMobile} />
                </div>
              </motion.div>
            )}
